...
const TestimonialsSection = () => {
  ...
  return (
    <section className="py-20 bg-muted" ref={testimonialsRef}>
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div 
  ...
  return (
    <section className="py-20 bg-background">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.div 
          className="bg-card rounded-lg p-8 md:p-12 shadow-elegant max-w-4xl mx-auto border border-border"
          ...
          <div className="border-t border-border pt-6">
            <div className="flex justify-between items-center">
              ...
              <div>
                ...
                <div className="font-semibold text-foreground">500 KLD</div>
              </div>
              <div>
                <div className="text-sm text-muted-foreground mb-1">Location</div>
                <div className="font-semibold text-foreground">Pune, Maharashtra</div>
              </div>
            </div>
          </div>
        </motion.div>
